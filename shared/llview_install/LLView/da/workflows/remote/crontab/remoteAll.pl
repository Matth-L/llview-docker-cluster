...
my $prefix = "crontab_remote"; # prefix for log/err files
...
system("cd $LLVIEW_DATA/$LLVIEW_SYSTEMNAME; perl $LLVIEW_HOME/da/LML_da.pl --nostepfile -v -conf $LLVIEW_CONF/remote/workflows/LML_da_slurm.conf 1>> $logfile 2>> $errfile");
